...
some of the explanation intermix with the explanation come from HOT (HOT.rdoc)
  ...
  ^ base extender / shortcut for common pattern in html
 ~^ re-assign base extender / shortcut
...
sometime I need result from base extender / shortcut already include
